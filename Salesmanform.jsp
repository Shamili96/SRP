...
if (x==null || x=="")
  ...
  var x=document.forms["myForm"]["orders"].value;
  if (x==null || x=="")
  {
  alert("Please,enter the number of orders");
  return false;
  }
  var x=document.forms["myForm"]["skm"].value;
  if (x==null || x=="")
  {
  alert("Please,enter the starting km");
  return false;
  }
  var x=document.forms["myForm"]["ekm"].value;
  if (x==null || x=="")
  {
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar"><div class="submb">
        <div class="article">
          <h2>SUBMIT DAILY RECORD:</h2>
		  
<form name="myForm" action="Salesman.jsp" onSubmit="return validateForm();" method="post">
<table>
<tr>
...
<tr>
	<th><p><i>NO. OF ORDERS:</i></p></th>
	<td><input type="text" name="orders"></td>
</tr>
<tr>
	<th><p><i>START KM:</i></p></th>
	<td><input type="text" name="skm"></td>
</tr>
<tr>
	<th><p><i>END KM:</i></p></th>
	<td><input type="text" name="ekm"></td>
</tr>
<tr>
	<th><p><i>COLLECTION AMOUNT:</i></p></th>
