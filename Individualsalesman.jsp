    ...
    <div class="content_resize">
      <div class="mainbar"><div class="submb">
        <div class="article">
		 ...
		 <form name="myForm" action="Individualsm.jsp" onSubmit="return validateForm();" method="post">
<p><i>EMPLOYEE ID:</i></p><input type="text" name="eid"><br><br>
